...
**Total Addressable Market:** 225 companies representing 9,434 work permits
...
**Decision Maker:** Global Mobility Manager, Project Manager

---

### Segment B: Gaming & Tech Studios (Fastest Growing)
...
- **Highest growth rates** - most urgent needs

**Booking Pattern:** Individual relocations, 3-6 month initial stays, potential extensions

**Decision Maker:** HR Business Partner, People Operations, Talent Acquisition
...
- **Klarna and Broadridge scaling fastest**

**Booking Pattern:** Through relocation management companies or internal mobility teams

**Decision Maker:** Global Mobility, Procurement, HR Director

---

### Segment D: Telecom & Kista Hub
...
- **Geographic advantage** - walking distance

**Decision Maker:** Procurement, Global Mobility, Project Manager

---

### Segment E: Engineering & Industrial (Secondary)
...
**Decision Maker:** HR, Project Manager, Facilities

---

### Segment F: Small Companies (5-15 permits) - Untapped Market
...
- Less competition from corporate housing vendors
- Often HR or Office Manager handles bookings
...
**Decision Maker:** HR Manager, Office Manager, CEO (at smallest companies)
...
- Target: HR Managers, Office Managers
...
- Near Arlanda Airport (frequent travelers)
...
4. **Klarna** - Fintech, 299 permits, high growth
5. **Capgemini** - IT consulting, 176 permits
6. **Spotify** - Tech, 150 permits
7. **King (Midasplayer)** - Gaming, 93 permits
8. **Kindred** - Gaming/betting, 91 permits, high growth
9. **EA DICE** - Gaming, 83 permits
