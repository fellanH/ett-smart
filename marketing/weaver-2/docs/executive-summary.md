...
1. **IT Consulting** - TCS, Capgemini, Accenture (rotating consultants)
2. **Gaming/Tech** - King, EA DICE, Spotify (relocations)
3. **Banks/Fintech** - Klarna, Swedbank (established programs)
4. **Telecom** - Ericsson in Kista (location match)

## Who to Target

- **Global Mobility Managers** at large companies
- **HR/People Ops** at tech/gaming companies
...
- `ett_smart_prospects_it_tech.csv` - Full prospect list
- `target-audience-profiles.md` - Detailed strategy
- `client-presentation.md` - Full presentation

## Bottom Line

These 46 companies are actively bringing international workers to Stockholm. They need housing. Your Kista property is next to Ericsson's HQ (1,290 permits). This is a focused, actionable target list for your marketing agency.
