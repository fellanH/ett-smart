...
3. **CHECK REVENUE:** Look at "Årlig omsättning" (Latest Year).
   ...
   - _Exception:_ If 0 SEK but company is new (≤ 18 months) -> **PROCEED**.

_If the company FAILS any check above, do not research further. Log the SKIP reason and move to next company._
_If the company PASSES all checks, proceed to Phase 2._
